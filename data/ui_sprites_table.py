...
SPRITES = {
    ...
    "config": {
        ...
        "tex#000": {
            ...
            "0074": _val("Українська", max_w=200), "0075": _val("Українська", ORANGE, 200),
            # назви опцій
            "0083": _lbl("Сповіщення про TIPS", cap_h=30), "0095": _lbl("Роздільність", max_w=304, cap_h=30),
            "0099": _lbl("Зупиняти пропуск при сигналі телефона", max_w=900, cap_h=30),
            "0111": _lbl("Режим екрана", max_w=600, cap_h=30),
            "0117": _lbl("Автоматичне швидке збереження", max_w=900, cap_h=30), "0143": _lbl("Пауза авторежиму", max_w=440),
            ...
            "0115": _banner("Основне"), "0151": _banner("Налаштування тексту"),
    ...
    "cellphone": {
        ...
        "tex#000": {
            ...
            "0016": _cell_blue("Отримана пошта"), "0020": _cell_blue("Вхідні"), "0024": _cell_blue("Змінити шпалери"),
            "0028": _cell_blue("Надіслана пошта"), "0032": _cell_blue("Вихідні"), "0036": _cell_blue("Рингтон дзвінка"),
